...
public class ModeloTabelaSacola extends AbstractTableModel {
	...
	public ModeloTabelaSacola(ArrayList<Object> lin, String[] col, boolean[] editavel) {
		setLinhas(lin);
		setColunas(col);
	...
	{
		if (numCol == 7) {
			if (getValueAt(numLin, 1).toString() == "true")
				return true;
		} if (numCol != 0)
			if (getValueAt(numLin, 0).toString() == "N")
				return false;
