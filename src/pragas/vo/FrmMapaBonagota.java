...
public class FrmMapaBonagota extends FrmMapaPai implements ActionListener {
	private static final long serialVersionUID = 5031825317513871017L;

	public FrmMapaBonagota() {
		setTitle(super.getTitle() + " - BONAGOTA");
		setFrameIcon(new ImageIcon(getClass().getResource("/icons/icon_bonagota_p.gif")));
		atualizaBotoes();
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		do {
			if (origem == btnsPontosPomar1.get(index)) {
				FrmDados fr = new FrmDados(index+1, 'B', indice);
				fr.setVisible(true);
