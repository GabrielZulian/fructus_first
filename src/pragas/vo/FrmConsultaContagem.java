...
public class FrmConsultaContagem extends FrmConsultaPai {
	...
	public FrmConsultaContagem() {
		...
		String[] colunas = new String[] {"Código Contagem", "Cod. Quadra", "Data", "Nro Quadra", "Qntd. Insetos", "Espécie", "Índice", "Qntd. Frascos"};
	...
	public void consultar() {
		...
		if (super.cbConsulta.getSelectedItem().equals("Data")) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Quantidade deve ser numérica!", "Erro consulta", JOptionPane.ERROR_MESSAGE);
			}
