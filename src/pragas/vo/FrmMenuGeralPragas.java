...
//		menuLancamentos.add(itemLancaTroca);
		...
		itemMandaEmail = new JMenuItem("Enviar e-mail com índices", new ImageIcon(getClass().getResource("/icons/icon_emailp.gif")));
		...
		btnLancaContagem.setToolTipText("Lançar Contagem");
